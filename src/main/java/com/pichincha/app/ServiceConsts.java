...
public class ServiceConsts {
    ...
    public static final String MSG_PROCESS_SERVICE_MOVEMENT = "movement %s successfully. %s: %s";
    public static final String MSG_ERROR_PROCESS_SERVICE = "account %s error, %s: %s. Message: %s";
    public static final String MSG_ERROR_PROCESS_SERVICE_MOVEMENT = "movement %s error, %s: %s. Message: %s";
}
